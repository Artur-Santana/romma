  ...
  return (
    <section className="border border-border-3 bg-surface p-7">
      ...
      <div className="grid grid-cols-2 gap-6 mt-4">
        <div>
          <span className="font-mono text-[17px] text-fg-4 tracking-[1px] uppercase block">
            UNIDADE
          </span>
          <span className="font-display font-bold text-[36px] leading-tight text-fg-1 block mt-1">
