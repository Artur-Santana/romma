    ...
    <section data-testid="parcelas-table" aria-label="HISTÓRICO DE PARCELAS" className="mt-10">
      ...
      <div className="mt-4 border border-border-3 bg-surface">
        <div className="grid grid-cols-[60px_1fr_1fr_1.2fr] border-b border-border-3 bg-[oklch(0.26_0_0)]">
          <div className="px-5 py-3 font-mono text-[13px] font-bold tracking-[1.4px] uppercase text-fg-4">#</div>
          <div className="px-5 py-3 font-mono text-[13px] font-bold tracking-[1.4px] uppercase text-fg-4">Vencimento</div>
          <div className="px-5 py-3 font-mono text-[13px] font-bold tracking-[1.4px] uppercase text-fg-4">Pagamento</div>
          <div className="px-5 py-3 font-mono text-[13px] font-bold tracking-[1.4px] uppercase text-fg-4">Status</div>
        </div>
        {parcelas.length === 0 && (
        ...
        {parcelas.map((parcela, i) => (
          ...
          >
            <div className="px-5 py-[14px]">
              <span className="font-mono text-[15px] text-fg-2 font-bold">
