...
export default function PortalDashboard() {
  ...
  return (
    <div className="romma-page bg-background min-h-full px-12 pt-12 pb-20">
      ...
      <h1 className="font-display font-bold text-[60px] leading-none tracking-[-2.4px] text-fg-1 m-0">Seu Contrato.</h1>
      <p className="font-mono text-[14px] text-fg-4 mt-2">Acesso restrito — contrato e histórico de parcelas.</p>

      {erro ? (
        <div className="px-4 py-[10px] mt-8 bg-[var(--danger-bg2)] border border-danger-fg font-mono text-[15px] text-danger-fg">
        ...
        <div className="mt-8">
          <h2 className="font-display font-bold text-[35px] text-fg-1">Nenhum contrato ativo</h2>
          <p className="font-mono text-[15px] text-fg-4 mt-2">Você não possui contrato ativo. Entre em contato com o proprietário.</p>
        </div>
      ) : (
        <>
          <div className="mt-8">
