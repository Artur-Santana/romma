...
export default function Unidades({}) {
  ...
  return (
    <div className="romma-page p-12 bg-background min-h-full">
          ...
          <form onSubmit={insertUnidade}>
            <div className="grid grid-cols-2 gap-4 mb-4">
              ...
              <label className="flex flex-col gap-1.5">
                <span className="font-mono text-[13px] tracking-[1px] uppercase text-fg-4">Edifício</span>
                <Select
            ...
            >
              ...
              <span className="font-mono text-[13px] text-fg-4 tracking-[1px] uppercase">Exibir valor publicamente</span>
            </div>
            ...
            <Button
              ...
              disabled={loading}
              className={cn(
                "bg-indigo text-fg-1 font-body font-bold text-[15px] tracking-[1.2px] uppercase px-8 py-[14px] rounded-none mt-2",
      ...
      {erroDelete && (
        <div className="bg-[var(--danger-bg2)] border-l-2 border-l-danger-fg px-4 py-3 font-mono text-[16px] text-danger-fg mb-4">{erroDelete}</div>
      )}

      <div className="flex flex-col gap-0 border border-border-3 bg-surface">
        {unidades.length === 0 && (
          <p className="px-5 py-4 font-mono text-[15px] text-fg-5">Nenhuma unidade cadastrada.</p>
        )}
