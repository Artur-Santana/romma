  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="font-display font-bold text-[42px] tracking-[-1.2px] text-fg-1 leading-[1.1]">
          {title}
        </div>
        <div className="text-[21px] leading-[1.5] text-fg-2">
          {body}
        </div>
        <div className="flex gap-3">
          <button
            onClick={onCancel}
            className="flex-1 border border-border-3 bg-transparent py-[14px] font-body font-bold text-[18px] tracking-[1.2px] uppercase text-fg-2 cursor-pointer"
          >
            {cancelLabel}
          </button>
          <button
            onClick={onConfirm}
            className={cn(
              "flex-1 border-none py-[14px] font-body font-bold text-[18px] tracking-[1.2px] uppercase cursor-pointer",
