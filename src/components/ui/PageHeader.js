  ...
  return (
    <div className="flex items-end justify-between mb-12">
      <div className="flex flex-col gap-2.5">
        ...
        <h2 className="font-display font-bold text-[60px] tracking-[-2.4px] text-fg-1 m-0 leading-none">
          {title}
        </h2>
        {subtitle && (
      ...
      {cta && (
        ...
        >
          <span className="font-mono text-[11px] text-indigo tracking-[1px]">
            {cta.code}
          </span>
          <span className="font-body font-bold text-[14px] tracking-[1.4px] uppercase text-fg-1">
            {cta.label}
          </span>
        </button>
      )}
