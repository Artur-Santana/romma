...
- [ ] **ACESSO-01**: Tela de acesso usa layout split-panel (variante A): foto de prédio dessaturada + cantoneiras douradas à esquerda, formulário à direita; no mobile faz stack (só formulário)
...
- [ ] **ACESSO-03**: Proprietário se cadastra via tela de Cadastro completa (nome, sobrenome, e-mail, telefone com máscara, senha, confirmar senha) com validações (obrigatórios, e-mail válido, telefone ≥10 dígitos, senha ≥6, senhas coincidem) e banner de sucesso "Verifique seu e-mail"
